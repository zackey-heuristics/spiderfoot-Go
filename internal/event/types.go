...
func buildRegistry() map[Type]TypeInfo {
	types := []Type{
		...
		BITCOIN_BALANCE, BLACKLISTED_AFFILIATE_IPADDR, BLACKLISTED_AFFILIATE_SUBNET,
		...
		DEFACED_COHOST, DEFACED_IPADDR, DESCRIPTION_ABSTRACT, DESCRIPTION_CATEGORY,
		...
		IBAN_NUMBER, INTERESTING_FILE, INTERESTING_FILE_CONTENT, INTERNET_NAME,
		...
		MALICIOUS_AFFILIATE_INTERNET_NAME, MALICIOUS_AFFILIATE_IPADDR, MALICIOUS_COHOST,
		...
		PASSWORD_COMPROMISED, PHONE_NUMBER, PHYSICAL_ADDRESS, PHYSICAL_COORDINATES,
		...
		TARGET_WEB_COOKIE, TCP_PORT_OPEN, TCP_PORT_OPEN_BANNER, TLD_PARENT,
