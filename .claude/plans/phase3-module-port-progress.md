...
**Branch**: `feature/1-go-rewrite` — Batch 20 committed locally.
**Last commit**: Batch 20 — darkweb search, company/crypto reputation, and network intel (ahmia, onionsearchengine, bitcoinabuse, opencorporates, onyphe, zetalytics).
**Registered modules**: 133 / 234.
**Next batch**: **Batch 21** — to be selected from remaining Python modules. Follow the plan-implement-test-review-commit cycle established in Batches 11-14.
...
**Total registered modules: 133** (dns_resolve + stor_db pre-existing, +120 new; vxvault + multiproxy dropped post-review)
